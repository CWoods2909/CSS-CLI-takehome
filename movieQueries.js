...
async function processMovies() {
    try {
        ...
        // if (argv.genre)
        //     filteredMovies = filterByGenre(filteredMovies, argv.genre);
        ...
        //     );
        // if (argv.director)
        //     filteredMovies = filterByDirector(filteredMovies, argv.director);

        // if (argv.actor)
        //     filteredMovies = filterByActor(filteredMovies, argv.actor);

        // if (argv.runtimeMoreThan)
        //     filteredMovies = filterByRuntime(
        //         filteredMovies,
        //         argv.runtimeMoreThan,
        //         "more-than"
        //     );

        // if (argv.runtimeLessThan)
        //     filteredMovies = filterByRuntime(
        //         filteredMovies,
        //         argv.runtimeLessThan,
        //         "less-than"
        //     );

        // if (argv.grossMin)
        //     filteredMovies = filterByGross(
        //         filteredMovies,
        //         argv.grossMin,
        //         "min"
        //     );
